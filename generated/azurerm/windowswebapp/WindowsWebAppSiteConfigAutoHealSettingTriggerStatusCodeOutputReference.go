...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference) Win32Status() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"win32Status",
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference) Win32StatusInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"win32StatusInput",
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference {
	...
	_jsii_.Create(
		"azurerm.windowsWebApp.WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference",
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference)SetWin32Status(val *float64) {
