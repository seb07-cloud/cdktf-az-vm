...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermServicePlan.DataAzurermServicePlan",
		reflect.TypeOf((*DataAzurermServicePlan)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermServicePlan.DataAzurermServicePlanConfig",
		reflect.TypeOf((*DataAzurermServicePlanConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermServicePlan.DataAzurermServicePlanTimeouts",
		reflect.TypeOf((*DataAzurermServicePlanTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermServicePlan.DataAzurermServicePlanTimeoutsOutputReference",
		reflect.TypeOf((*DataAzurermServicePlanTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
