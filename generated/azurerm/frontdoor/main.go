...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.frontdoor.FrontdoorBackendPoolSettings",
		reflect.TypeOf((*FrontdoorBackendPoolSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.frontdoor.FrontdoorBackendPoolSettingsList",
	...
	_jsii_.RegisterClass(
		"azurerm.frontdoor.FrontdoorBackendPoolSettingsOutputReference",
