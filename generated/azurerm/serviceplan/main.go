...
func init() {
	_jsii_.RegisterClass(
		"azurerm.servicePlan.ServicePlan",
		reflect.TypeOf((*ServicePlan)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "perSiteScalingEnabled", GoGetter: "PerSiteScalingEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "perSiteScalingEnabledInput", GoGetter: "PerSiteScalingEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPerSiteScalingEnabled", GoMethod: "ResetPerSiteScalingEnabled"},
	...
	_jsii_.RegisterStruct(
		"azurerm.servicePlan.ServicePlanConfig",
		reflect.TypeOf((*ServicePlanConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.servicePlan.ServicePlanTimeouts",
		reflect.TypeOf((*ServicePlanTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.servicePlan.ServicePlanTimeoutsOutputReference",
		reflect.TypeOf((*ServicePlanTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
