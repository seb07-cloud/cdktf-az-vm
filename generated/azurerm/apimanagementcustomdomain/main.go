...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.apiManagementCustomDomain.ApiManagementCustomDomainGateway",
		reflect.TypeOf((*ApiManagementCustomDomainGateway)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.apiManagementCustomDomain.ApiManagementCustomDomainGatewayList",
	...
	_jsii_.RegisterClass(
		"azurerm.apiManagementCustomDomain.ApiManagementCustomDomainGatewayOutputReference",
