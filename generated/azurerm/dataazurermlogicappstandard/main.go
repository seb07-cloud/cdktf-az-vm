...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermLogicAppStandard.DataAzurermLogicAppStandardSiteConfigScmIpRestriction",
		reflect.TypeOf((*DataAzurermLogicAppStandardSiteConfigScmIpRestriction)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermLogicAppStandard.DataAzurermLogicAppStandardSiteConfigScmIpRestrictionHeaders",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermLogicAppStandard.DataAzurermLogicAppStandardSiteConfigScmIpRestrictionList",
