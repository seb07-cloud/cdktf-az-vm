...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermSharedImage.DataAzurermSharedImagePurchasePlan",
		reflect.TypeOf((*DataAzurermSharedImagePurchasePlan)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermSharedImage.DataAzurermSharedImagePurchasePlanList",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermSharedImage.DataAzurermSharedImagePurchasePlanOutputReference",
