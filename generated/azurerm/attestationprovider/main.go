...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.attestationProvider.AttestationProviderPolicy",
		reflect.TypeOf((*AttestationProviderPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.attestationProvider.AttestationProviderPolicyList",
	...
	_jsii_.RegisterClass(
		"azurerm.attestationProvider.AttestationProviderPolicyOutputReference",
