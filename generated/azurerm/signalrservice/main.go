...
func init() {
	...
	_jsii_.RegisterClass(
		"azurerm.signalrService.SignalrServiceIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.signalrService.SignalrServiceLiveTrace",
		reflect.TypeOf((*SignalrServiceLiveTrace)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.signalrService.SignalrServiceLiveTraceOutputReference",
