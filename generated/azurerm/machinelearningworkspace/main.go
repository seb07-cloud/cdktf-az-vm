...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicAccessBehindVirtualNetworkEnabled", GoGetter: "PublicAccessBehindVirtualNetworkEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "publicAccessBehindVirtualNetworkEnabledInput", GoGetter: "PublicAccessBehindVirtualNetworkEnabledInput"},
