...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermVirtualMachineScaleSet.DataAzurermVirtualMachineScaleSetInstances",
		reflect.TypeOf((*DataAzurermVirtualMachineScaleSetInstances)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermVirtualMachineScaleSet.DataAzurermVirtualMachineScaleSetInstancesList",
