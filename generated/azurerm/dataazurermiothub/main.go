...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermIothub.DataAzurermIothubIdentity",
		reflect.TypeOf((*DataAzurermIothubIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermIothub.DataAzurermIothubIdentityList",
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermIothubIdentityList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermIothub.DataAzurermIothubIdentityOutputReference",
