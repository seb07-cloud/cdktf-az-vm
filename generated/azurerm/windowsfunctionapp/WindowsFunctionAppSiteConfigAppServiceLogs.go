...
type WindowsFunctionAppSiteConfigAppServiceLogs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.0.2/docs/resources/windows_function_app#disk_quota_mb WindowsFunctionApp#disk_quota_mb}
