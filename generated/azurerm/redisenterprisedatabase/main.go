...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "linkedDatabaseGroupNickname", GoGetter: "LinkedDatabaseGroupNickname"},
			_jsii_.MemberProperty{JsiiProperty: "linkedDatabaseGroupNicknameInput", GoGetter: "LinkedDatabaseGroupNicknameInput"},
			_jsii_.MemberProperty{JsiiProperty: "linkedDatabaseId", GoGetter: "LinkedDatabaseId"},
			_jsii_.MemberProperty{JsiiProperty: "linkedDatabaseIdInput", GoGetter: "LinkedDatabaseIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLinkedDatabaseGroupNickname", GoMethod: "ResetLinkedDatabaseGroupNickname"},
			_jsii_.MemberMethod{JsiiMethod: "resetLinkedDatabaseId", GoMethod: "ResetLinkedDatabaseId"},
