...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceManagedDiskIdentity",
		reflect.TypeOf((*DataAzurermDatabricksWorkspaceManagedDiskIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceManagedDiskIdentityList",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceStorageAccountIdentityOutputReference",
