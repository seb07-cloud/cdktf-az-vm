...
func (j *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference) Win32Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"win32Status",
...
func (j *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference) Win32StatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"win32StatusInput",
...
func NewLinuxWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference {
	...
	_jsii_.Create(
		"azurerm.linuxWebApp.LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference",
...
func (j *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCodeOutputReference)SetWin32Status(val *string) {
