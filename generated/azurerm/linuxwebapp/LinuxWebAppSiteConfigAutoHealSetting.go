...
type LinuxWebAppSiteConfigAutoHealSetting struct {
	...
	// trigger block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.0.2/docs/resources/linux_web_app#trigger LinuxWebApp#trigger}
