...
type ApplicationGatewayRewriteRuleSet struct {
	...
	// rewrite_rule block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.0.2/docs/resources/application_gateway#rewrite_rule ApplicationGateway#rewrite_rule}
